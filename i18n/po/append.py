...
lines = ["Listening Exercises", "Match sounds to words", "Patterns", "Number Patterns", "Letter Patterns", "Color Patterns", "Image Patterns", "Fraction Patterns", "Shape Patterns", "Complete the pattern on the top line."]
