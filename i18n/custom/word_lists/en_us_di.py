...
di = [[114, 'act', 'add', 'age', 'ago', 'air', 'all', 'and', 'any', 'are', 'art', 'bad', 'bed', 'big', 'bit', 'box',
      ...
      [381, 'able', 'also', 'area', 'arms', 'army', 'away', 'baby', 'back', 'ball', 'bank', 'base', 'bear', 'beat',
       ...
       'list', 'live', 'long', 'look', 'lost', 'loud', 'love', 'made', 'main', 'make', 'many', 'mark', 'meat', 'meet',
       'milk', 'mind', 'mine', 'miss', 'moon', 'more', 'most', 'move', 'much', 'must', 'name', 'near', 'need', 'next',
       'nose', 'note', 'noun', 'once', 'only', 'open', 'over', 'page', 'pair', 'park', 'part', 'past', 'plan', 'play',
       'plod', 'plot', 'plow', 'plug', 'plum', 'poem', 'pole', 'poor', 'pray', 'prod', 'prop', 'race', 'rain', 'read',
       'rest', 'rich', 'ride', 'ring', 'rise', 'road', 'rock', 'room', 'root', 'rope', 'rose', 'rule', 'safe', 'said',
       'sail', 'same', 'sand', 'save', 'scab', 'scan', 'scar', 'scat', 'seat', 'seen', 'sell', 'send', 'sent', 'ship',
       'shop', 'show', 'side', 'sign', 'sing', 'size', 'skid', 'skin', 'skip', 'skit', 'slab', 'slam', 'slap', 'sled',
       'slid', 'slim', 'slip', 'slit', 'slot', 'slow', 'slug', 'smog', 'snag', 'snap', 'snip', 'snob', 'snow', 'snug',
       'soft', 'soil', 'some', 'song', 'soon', 'span', 'spat', 'spin', 'spot', 'spur', 'star', 'stay', 'stem', 'step',
       'stew', 'stir', 'stop', 'such', 'sure', 'swam', 'swan', 'swap', 'swat', 'sway', 'swim', 'tail', 'take', 'talk',
       'tall', 'team', 'tell', 'test', 'than', 'that', 'them', 'then', 'they', 'thin', 'this', 'thus', 'tied', 'time',
       'tiny', 'told', 'tone', 'took', 'town', 'trap', 'tray', 'tree', 'trek', 'trim', 'trip', 'trot', 'true', 'tube',
       'turn', 'type', 'unit', 'upon', 'verb', 'very', 'view', 'wait', 'wall', 'want', 'warm', 'wash', 'wear', 'week',
       'well', 'went', 'were', 'west', 'what', 'when', 'wide', 'wife', 'wild', 'will', 'wind', 'wire', 'wish', 'with',
       'wood', 'work', 'yard', 'your'],
      [499, 'about', 'above', 'after', 'again', 'ahead', 'allow', 'alone', 'along', 'among', 'angle', 'apple', 'asked',
       ...
       'bones', 'brace', 'braid', 'brain', 'brake', 'brand', 'brass', 'brave', 'brawl', 'bread', 'break',

       'brick', 'bride', 'bring', 'brisk', 'broad', 'broil', 'broke', 'brood', 'brook', 'broom', 'broth', 'brown',
       'brush', 'build', 'built', 'carry', 'catch', 'cause', 'cells', 'cents', 'chart', 'check', 'chief', 'child',
       'clack', 'claim', 'clamp', 'clang', 'clash', 'clasp', 'class', 'clean', 'clear', 'cleat', 'clerk', 'click',
       'cliff', 'climb', 'cling', 'clink', 'cloak', 'clock', 'clomp', 'close', 'cloth', 'cloud', 'clove', 'clown',
       'cluck', 'clump', 'coast', 'color', 'could', 'count', 'crack', 'craft', 'crane', 'crash', 'crawl', 'crazy',
       'creek', 'creep', 'cried', 'croak', 'crook', 'crops', 'cross', 'crowd', 'crown', 'crumb', 'crust', 'dance',

       'draft', 'drain', 'drake', 'drank', 'drape', 'dread', 'dream', 'dress', 'drift', 'drill', 'drink', 'drive',
       'droop', 'drove', 'early', 'earth', 'eight', 'enjoy', 'equal', 'every', 'field', 'fight', 'first', 'flake',
       'flame', 'flare', 'flash', 'fleck', 'fleet', 'flesh', 'flick', 'fling', 'flint', 'float', 'flock', 'flood',
       'floor', 'floss', 'flour', 'fluff', 'fluid', 'fluke', 'flunk', 'flush', 'flute', 'force', 'found', 'frail',
       ...
       'heard', 'heart', 'heavy', 'horse', 'hours', 'house', 'human', 'known', 'large', 'later', 'learn',

       'least', 'leave', 'level', 'light', 'major', 'march', 'match', 'maybe', 'means', 'metal', 'might', 'miles',
       'money', 'mouth', 'music', 'never', 'night', 'north', 'ocean', 'often', 'order', 'other', 'paint', 'paper',
       'party', 'piece', 'place', 'plaid', 'plain', 'plane', 'plank', 'plant', 'plate', 'plead', 'pleat', 'plink',
       'plump', 'point', 'power', 'press', 'price', 'pride', 'print', 'prize', 'probe', 'proof', 'proud', 'prove',
       'prowl', 'prune', 'quiet', 'quite', 'radio', 'ready', 'right', 'river', 'round', 'scald', 'scale', 'scalp',
       'scamp', 'scare', 'scarf', 'scold', 'scoop', 'scoot', 'scope', 'score', 'scour', 'scout', 'scram', 'scrap',
       'screw', 'scrub', 'scuba', 'scuff', 'seeds', 'sense', 'serve', 'seven', 'shall', 'shape', 'sharp', 'shoes',
       'short', 'shown', 'sight', 'since', 'skate', 'skill', 'skirt', 'skull', 'skunk', 'slack', 'slant', 'slate',

       'sleek', 'sleep', 'sleet', 'slept', 'slice', 'slick', 'slide', 'slime', 'sling', 'slope', 'slump', 'slush',
       'smack', 'small', 'smart', 'smash', 'smear', 'smell', 'smile', 'smock', 'smoke', 'snack', 'snail', 'snake',
       'snare', 'snarl', 'sneak', 'sniff', 'snoop', 'snore', 'snout', 'solve', 'sound', 'south', 'space', 'spare',
       'spark', 'speak', 'spear', 'speck', 'speed', 'spell', 'spend', 'spent', 'spike', 'spill', 'spine', 'spire',
       'split', 'spoil', 'spoke', 'spoon', 'sport', 'spout', 'spray', 'sprig', 'squat', 'squid', 'stack', 'staff',
       'stage', 'stain', 'stair', 'stake', 'stale', 'stalk', 'stall', 'stamp', 'stand', 'stare', 'stars', 'start',
       'state', 'steak', 'steal', 'steam', 'steel', 'steep', 'steer', 'stick', 'stiff', 'still', 'stilt', 'sting',
       'stink', 'stock', 'stone', 'stood', 'stool', 'stoop', 'store', 'storm', 'story', 'stove', 'strap', 'straw',

       'stray', 'strip', 'strum', 'study', 'style', 'sugar', 'swamp', 'swarm', 'sweat', 'sweep', 'sweet', 'swell',
       'swept', 'swift', 'swine', 'swing', 'swish', 'swoop', 'table', 'terms', 'their', 'there', 'these', 'thick',
       'thing', 'think', 'third', 'those', 'three', 'today', 'tools', 'total', 'touch', 'trace', 'track', 'trade',
       'trail', 'train', 'tramp', 'trash', 'tread', 'treat', 'trees', 'tribe', 'trick', 'troll', 'tromp', 'troop',
       'trout', 'truck', 'truly', 'trunk', 'trust', 'truth', 'uncle', 'under', 'until', 'value', 'visit', 'voice',
       'vowel', 'watch', 'water', 'waves', 'where', 'which', 'while', 'white', 'whole', 'whose', 'wings', 'woman',
       'women', 'words', 'world', 'would', 'write', 'wrong', 'wrote', 'years', 'young'],
      [241, 'across', 'action', 'afraid', 'agreed', 'almost', 'always', 'amount', 'answer', 'appear', 'around',
       ...
       'bruise', 'called', 'cannot', 'cattle', 'caught', 'center', 'chance', 'change', 'choose', 'church', 'circle',
       'closet', 'clutch', 'column', 'common', 'corner', 'cotton', 'course', 'cradle', 'crayon', 'create', 'crunch',

       'desert', 'design', 'direct', 'doctor', 'dragon', 'during', 'effect', 'either', 'energy', 'engine', 'enough',
       'entire', 'except', 'expect', 'family', 'famous', 'father', 'figure', 'filled', 'flight', 'flower', 'forest',
       'freeze', 'friend', 'fright', 'fringe', 'frozen', 'garden', 'glance', 'glitch', 'grapes', 'grease', 'grouch',
       'ground', 'grudge', 'inches', 'inside', 'island', 'itself', 'joined', 'jumped', 'killed', 'length', 'lifted',
       'listen', 'little', 'matter', 'melody', 'method', 'middle', 'modern', 'moment', 'months', 'mother', 'nation',
       'notice', 'number', 'object', 'office', 'oxygen', 'passed', 'people', 'period', 'person', 'phrase', 'picked',
       'plains', 'planet', 'plants', 'player', 'please', 'pledge', 'plenty', 'plural', 'pounds', 'praise', 'prance',
       'prayer', 'pretty', 'priest', 'prince', 'prison', 'pulled', 'pushed', 'raised', 'rather', 'really', 'reason',
       'record', 'region', 'remain', 'report', 'result', 'return', 'rhythm', 'rolled', 'scarce', 'school', 'scorch',

       'scrape', 'scrawl', 'scream', 'screen', 'script', 'scroll', 'second', 'seemed', 'should', 'silent', 'simple',
       'single', 'sister', 'sketch', 'sleepy', 'sleeve', 'slight', 'slowly', 'smiled', 'smooth', 'smudge', 'snatch',
       'sneeze', 'speech', 'spirit', 'splash', 'splint', 'sponge', 'sprain', 'sprang', 'sprawl', 'spread', 'spring',
       'sprint', 'sprout', 'spruce', 'square', 'squash', 'squeak', 'squeal', 'squint', 'squirm', 'squirt', 'squish',
       'stable', 'staple', 'starch', 'starve', 'statue', 'steady', 'stereo', 'sticky', 'stingy', 'stitch', 'strain',
       'strand', 'streak', 'stream', 'street', 'strict', 'stride', 'strike', 'string', 'stripe', 'stroke', 'stroll',
       'strong', 'struck', 'suffix', 'summer', 'supply', 'swatch', 'swerve', 'switch', 'system', 'though', 'toward',
       'travel', 'trough', 'valley', 'walked', 'weight', 'wheels', 'window', 'winter', 'within', 'wonder', 'yellow'],
