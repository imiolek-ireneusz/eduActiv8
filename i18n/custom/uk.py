...
d["a4a_sport"] = ["дзюдо", "плавання", "велогонка", "розтяжка", "шолом", "ковзани", "ходьба", "біг", "пірнання",
                  ...
                  "скакалка"]
d["a4a_body"] = ["зуби", "щока", "кісточка", "коліно", "палець ноги", "мускул", "рот", "ступня", "кисть руки", "лікоть", "волосся",
                 "вія", "борода", "пупок", "великий палець", "груди", "ніздря", "ніс", "поперек", "рука", "брова",
                 "кулак", "шия", "зап’ясток", "горло", "око", "гомілка", "хребет", "вухо", "палець", "нога", "коса",
...
d["a4a_people"] = ["дівчина", "хлопець", "син", "однокласники", "друзі", "немовля", "дитя", "татусь", "матуся",
                   ...
                   "наречена", "тітонька", "бабуся", "закохані", "хлопчина", "двійнята", "дикуни", "хлопчик", "сестри",
                   "жінка", "леді"]
d["a4a_food"] = ["цукерка", "ковбаса", "гамбургер", "стейк", "помадка", "пончик", "кокос", "рис", "морозиво", "желе",
                 ...
                 "чіпси", "торт", "пюре", "чай", "булка", "сир", "яловичина", "бутерброд", "шматочки", "присипка",
                 "піца", "борошно", "жувальна різинка", "спагеті", "печеня", "тушковане м’ясо", "намащування",
...
d["a4a_clothes_n_accessories"] = ["прикраси", "шкарпетка", "піджак", "шпилька", "пляма", "шорти", "кишеня", "намисто",
                                  "спортивний светр", "уніформа", "плащ", "штани", "сонячні окуляри", "шуба", "светр",
                                  "сорочка", "сандалі", "костюм", "піжама", "спідниця", "блискавка", "чоботи", "камінь",
...
d["a4a_actions"] = ["лизати", "закидати", "молити", "падати", "дряпати", "торкати", "нюхати", "дивитися", "дертися",
                    ...
                    "розливати", "митися", "кричати", "рвати", "плавати", "тягти", "поїсти", "цілуватися", "сидіти",
                    "вилуплюватися", "блимати", "слухати", "цілувати", "грати", "мити", "балакати", "вести", "пити",
                    "літати", "жонглювати", "кусати", "мести", "роздивлятися", "в’язати", "піднімати", "тримати",
                    "читати", "квакати", "витріщатися", "їсти"]
...
d["a4a_jobs"] = ["клоун", "інженер", "священник", "ветеринар", "суддя", "повар", "атлет", "бібліотекарка", "жонглер",
                 ...
                 "принцеса", "пожежник", "черниця", "пірат", "ковбой", "електрик", "медсестра", "король",
...
d["a4a_fruit_n_veg"] = ["морква", "ожина", "селера", "ріпа", "какао", "персик", "диня", "грейпфрут", "броколі",
                        ...
                        "вишня", "кабачок", "чорниця", "груша", "апельсин", "гарбуз", "авокадо", "часник", "цибуля",
...
d["a4a_transport"] = ["яхта", "таксі", "автомобіль", "велосипед", "пліт", "педаль", "автобус", "кермо", "човен",
                      "пікап", "сани", "килим", "мотоцикл", "потяг", "корабель", "фургон", "каное", "ракета", "мачта",
                      "санчата", "велосипед"]
