...
d["a4a_sport"] = ['judo', 'piscina', 'ciclista', 'estirar', 'casc', '<ice skating>', 'caminar', 'córrer', 'nedar', 'saltar', 'caminar', '<boxing>', 'hoquei', 'cursa', 'llançar', 'patinar', 'guanyar', 'ajupir', 'esquiar', 'golf', '<whistle>', 'torxa', '<sailing>', 'dret', 'tennis', 'saltar', 'rem', 'fúting', 'corda']
