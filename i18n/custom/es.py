...
d["a4a_sport"] = ['judo', 'piscina', 'ciclista', 'estirar', 'casco', '<ice skating>', 'caminar', 'correr', 'correr', 'nadar', 'salto', 'caminata', '<boxing>', 'hockey', 'carrera', 'lanzar', 'patinar', 'ganar', 'agacharse', 'esquiar', 'golf', '<whistle>', 'antorcha', '<sailing>', 'derecho', 'tenis', 'saltar', 'remo', 'footing', 'cuerda']
