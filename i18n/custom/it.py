...
d["a4a_sport"] = ['<judo>', 'la piscina', 'andare in bicicletta', '<stretch>', '<helmet>', '<ice skating>', 'camminare', 'corre', 'nuotare', '<hop>', '<hike>', '<boxing>', '<hockey>', '<race>', 'lanciare', 'pattinare', '<win>', '<squat>', 'sciare', '<golf>', '<whistle>', 'la torcia', '<sailing>', '<stand>', '<tennis>', 'saltare', '<rowing>', 'correre', 'la corda']
...
d["a4a_food"] = ['la caramella', '<sausage>', '<hamburger>', '<steak>', '<fudge>', '<doughnut>', '<coconut>', 'il riso', '<ice cream>', '<jelly>', '<yoghurt>', '<dessert>', '<pretzel>', '<peanut>', '<jam>', '<feast>', 'i biscotti', '<bacon>', '<spice>', '<coffee>', '<pie>', '<lemonade>', 'il cioccolato', '<water bottle>', 'la merenda', 'il ghiaccio', '<sugar>', 'la salsa', '<soup>', "il succo d'arancia", '<fries>', 'il dolce', '<mashed potatoes>', '<tea>', 'il panino', 'il formaggio', '<beef>', 'il panino', '<slice>', '<sprinkle>', '<pizza>', 'la farina', 'la gomma da masticare', 'gli spaghetti', '<roast>', 'lo stufato', 'spalmare', '<meat>', '<milk>', '<meal>', 'la pannocchia', 'il pane', '<walnut>', '<egg>', '<hot dog>', '<ham>']
