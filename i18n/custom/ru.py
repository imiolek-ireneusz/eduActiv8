...
d["a4a_animals"] = ["корова", "индейка", "креветка", "волк", "пантера", "панда", "сорока", "моллюск", "пони", "мышь",
                    ...
                    "курица", "оса", "хамелеон", "кит", "ёжик", "олень", "лось", "пчела", "змейка", "сорокопут", "ослик",
...
d["a4a_food"] = ["конфета", "сосиска", "гамбургер", "бифштекс", "помадка", "пончик", "кокос", "рис", "мороженое",
                 "желе", "йогурт", "десерт", "крендель", "арахис", "варенье", "курица", "печенье", "бекон", "специи",
                 ...
                 "молоко", "пища", "кукуруза", "хлеб", "орех", "яйцо", "хот-дог", "колбаса"]
d["a4a_clothes_n_accessories"] = ["украшение", "носок", "пиджак", "шпилька", "пятно", "шорты", "карман", "ожерелье",
                                  ...
                                  "кроссовки", "жилет", "перчатки", "шнурок", "заплатка", "шарф", "обувь", "пуговица",
                                  "платье", "пояс", "подошва", "мантия", "трусы", "балахон", "комбинезон"]
d["a4a_actions"] = ["лизать", "забрасывать", "молиться", "падать", "царапать", "трогать", "нюхать", "смотреть",
                    ...
                    "лепить", "ловить", "хлопать", "рыдать", "петь", "встречаться", "продавать", "клевать", "ударить",
                    "становиться на колени", "искать", "танцевать", "кашлять", "резать", "мыслить", "гавкать", "говорить",
                    "веселить", "стряпать", "писать", "бить", "бренчать", "учиться", "пахать", "мечтать", "отправлять",
                    "нырять", "шептать", "рыдать", "трясти", "кормить", "ползать", "обосноваться", "разливать", "мыть",
                    ...
                    "кусать", "подметать", "смотреть", "вязать", "поднимать", "держать", "читать", "квакать", "оставаться",
                    "есть"]
d["a4a_construction"] = ["маяк", "дверь", "цирк", "церковь", "конура", "храм", "дым", "дымоход", "кирпич", "колодец",
                         ...
                         "колокольня", "гараж", "мечеть", "госпиталь", "палатка", "дом", "стенка", "банк", "ставень",
                         "хижина"]
...
dp["a4a_animals"] = ["корова", "индейка", "креветка", "волк", "пантэра", "панда", "сорока", "моллюск", "пони", "мышь",
                     "мопс", "ко-ала", "лягушка", "божья коровка", "горилла", "лама", "стер-вя-тник", "хомяк", "птица",
                     "морская звез-да", "ворона", "длиннохвостый попугай", "гусе-ни-ца", "тигр", "колибри", "пиранья",
                     "сви-нья", "скорпи-он", "ли-са", "леопард", "игу-ана", "дель-фин", "летучая мышь", "цыплёнок", "краб",
                     "курица", "о-са", "хамеле-он", "кит", "ёжик", "о-лень", "лось", "пче-ла", "змейка", "сороко-пут", "ос-лик",
                     "морская свинка", "ле-ни-вец", "конь", "пинг-вин", "выдра", "медведь", "зебра", "страус", "верблюд",
                     "анти-лопа", "ле-мур", "голубь", "лама", "крот", "скат", "ба-ран", "скунс", "медуза", "ов-ца", "акула",
                     "котёнок", "о-лень", "улитка", "фламинго", "кро-лик", "у-стрица", "бобр", "во-ро-бей", "голубь", "орёл",
                     "жук", "бегемот", "со-ва", "кобра", "сала-мандра", "гусь", "кен-гу-ру", "стреко-за", "лягушка",
                     "пели-кан", "каль-мар", "львёнок", "я-гу-ар", "утка", "яще-ри-ца", "носорог", "гиена", "бык", "пав-лин",
                     "попугай", "лось", "крокодил", "муравей", "козёл", "крольчонок", "лев", "белка", "опоссум",
                     "шим-пан-зэ", "оленёнок", "сус-лик", "слон", "жи-раф", "паук", "щенок", "сойка", "тю-лень", "пе-тух",
                     "чере-паха", "бык", "кошка", "крыса", "улитка", "би-зон", "чёрный дрозд", "ле-бедь", "о-мар",
                     "собака", "ко-мар", "змейка", "цыплёнок", "муравьед"]
dp["a4a_sport"] = ["дзю-до", "плава-ние", "вело-гонка", "растяжка", "шлем", "конь-ки", "ходь-ба", "бег", "бег", "ныряние",
                  "батут", "пеший туризм", "бокс", "хок-кей", "забег", "бросок", "скейт", "победа", "приседания", "лыжи",
                  "гольф", "свисток", "факел", "яхта", "стойка", "тэнис", "скачок", "гребля", "бег трус-цой",
                  "скакалка"]
dp["a4a_body"] = ["зуб", "ще-ка", "кос-точка", "колено", "пя-та", "мускул", "рот", "ступ-ня", "ру-ка", "ло-коть", "во-лосы",
                 "ресничка", "боро-да", "пупок", "боль-шой па-лец", "грудь", "нозд-ря", "нос", "пояс-ница", "ру-ка", "бровь",
                 "кулак", "шея", "за-пястье", "горло", "глаз", "но-га", "спи-на", "ухо", "па-лец", "ступ-ня", "боро-да",
                 "ли-цо", "спи-на", "подбородок", "яго-дицы", "бед-ро", "живот"]
dp["a4a_people"] = ["де-вушка", "парень", "сын", "однокласники", "дру-зья", "ма-лыш", "ребёнок", "папа", "мама",
                   "близне-цы", "братья", "мужчина", "мать", "де-душка", "се-мья", "жен-щина", "же-на", "муж", "невеста",
                   "тётя", "ба-бушка", "влюблённые", "мальчик", "двойняшки", "ди-ка-ри", "мальчик", "сёстры", "жен-щина",
                   "леди"]
dp["a4a_food"] = ["конфета", "сосиска", "гам-бургер", "бифш-тэкс", "помадка", "пон-чик", "ко-кос", "рис", "мо-роженое",
                 "же-ле", "йо-гурт", "десерт", "крендель", "арахис", "варенье", "ку-рица", "печенье", "бе-кон", "спе-ции",
                 "кофе", "пирог", "лимонад", "шоколад", "бутылка с во-дой", "обед", "лёд", "сахар", "соус", "суп", "сок",
                 "чипсы", "торт", "пю-рэ", "чай", "булка", "сыр", "отбив-ная", "бутэрброд", "лом-тик", "посыпка", "пица",
                 "мука", "жевательная резинка", "спагетти", "жаркое", "напиток", "тушёное мясо", "на-ма-занное", "мясо",
                 "мо-ло-ко", "пища", "кукуруза", "хлеб", "о-рех", "я-йцо", "хот-дог", "колба-са"]
dp["a4a_clothes_n_accessories"] = ["украшение", "носок", "пиджак", "шпилька", "пя-тно", "шорты", "кар-ман", "оже-релье",
                                  "свитэр", "уни-форма", "плащ", "шта-ны", "солнечные оч-ки", "куртка", "пулловер",
                                  ",блузка", "сандалии", "кос-тюм", "пижама", "юбка", "мол-ния", "туфли", "камень",
                                  "га-лстук", "шлёпанцы", "перчатки", "шляпа", "ру-кав", "кепка", "ку-па-льник",
                                  "кросовки", "жилет", "перчатки", "шнурок", "заплатка", "шарф", "обувь", "пуговица",
                                  "платье", "пояс", "подошва", "ман-тия", "тру-сы", "бала-хон", "комбине-зон"]
dp["a4a_actions"] = ["лизать", "заб-ра-сывать", "молиться", "па-дать", "ца-рапать", "тро-гать", "ню-хать", "смотреть",
                    "карабкаться", "копать", "выть", "спать", "исследовать", "рисовать", "обнимать", "учить", "дремать",
                    "лепить", "ловить", "хло-пать", "рыдать", "петь", "встречаться", "продавать", "клевать", "у-да-рить",
                    "становиться на колени", "искать", "танцевать", "каш-лять", "ре-зать", "мы-слить", "га-вкать", "говорить",
                    "веселить", "стря-пать", "писать", "бить", "бренчать", "учиться", "пахать", "мечтать", "отправлять",
                    "нырять", "шептать", "рыдать", "тряс-ти", "кормить", "по-лзать", "обосно-ваться", "разливать", "мыть",
                    "кричать", "рвать", "пла-вать", "тянуть", "поесть", "целовать", "сидеть", "вылуп-ляться", "мигать",
                    "слу-шать", "цело-ваться", "играть", "мыть", "говорить", "вес-ти", "пить", "летать", "жонглировать",
                    "кусать", "подметать", "смотреть", "вязать", "поднимать", "держать", "читать", "ква-кать", "оста-ваться",
                    "есть"]
dp["a4a_construction"] = ["маяк", "дверь", "цирк", "церковь", "кону-ра", "храм", "дым", "дымоход", "кирпич", "ко-ло-дец",
                         "у-лица", "за-мок", "мага-зин", "ле-сница", "школа", "ферма", "мост", "плотина", "пирамида",
                         "кладовая", "мель-ница", "о-кно", "до-мик", "ступенька", "мага-зин", "са-рай", "крыша",
                         "коло-кольня", "га-раж", "мечеть", "го-спиталь", "палатка", "дом", "стенка", "банк", "ставень",
                         "хижи-на"]
...
dp["a4a_jobs"] = ["клоун", "инже-нер", "свя-ще-ник", "ветери-нар", "су-дья", "повар", "атлет", "библио-текарь", "жонглёр",
                 "полицейский", "водо-провод-чик", "же-тон-щик", "коро-лева", "фермер", "фо-кусник", "рыцарь", "доктор",
                 "ка-менщик", "уборщица", "учитель", "о-хот-ник", "солдат", "музыкант", "юрист", "рыбак", "принцесса",
                 "по-жар-ник", "монахиня", "пират", "ков-бой", "элект-рик", "няня", "ко-роль", "президент", "клерк",
                 "плот-ник", "жо-кей", "рабочий", "ме-ха-ник", "пилот", "актёр", "повар", "студент", "мяс-ник", "бух-галтер",
                 "принц", "поп", "моряк", "боксёр", "бале-рина", "тренер", "астронавт", "ху-до-жник", "анэ-стезиолог",
                 "учёный"]
dp["a4a_fruit_n_veg"] = ["мор-ковь", "смородина", "сельде-рей", "ретька", "ка-као", "персик", "дыня", "грэйпфрут",
                        ...
                        "капуста", "вишни", "тыква", "еже-вика", "груша", "апель-син", "тыква", "аво-кадо", "чеснок",
                        "лук", "яб-ло-ко", "лайм", "цветная капуста", "манго", "салат", "ли-мон", "бакла-жан", "арти-шоки",
                        "сливы", "лук", "ба-наны", "па-пая"]
dp["a4a_transport"] = ["яхта", "такси", "автомо-биль", "велосипед", "плот", "пе-даль", "автобус", "руль", "лотка", "пикап",
                      "сани", "ковёр", "мото-цикл", "по-езд", "ко-рабль", "фур-гон", "каноэ", "ракета", "мачта", "санки",
                      "велосипед"]
