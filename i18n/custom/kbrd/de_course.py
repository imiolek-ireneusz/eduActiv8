...
from i18n.custom.kbrd.de_cinderella import cinderella
from i18n.custom.word_lists.de_di import di
...
base_qwerty = [
    ...
    [[4, 4, 4, 3, 3, 3, 3],
     ["jzj juj ", "jzj juj kik lol pop ", "jnzj jmuj ", "kiujk loikj ", "polkiuj jnhuj kmjik ", "plokijuhz hzjukilop ",
      "zhikujolp pokuh "]
     ],
