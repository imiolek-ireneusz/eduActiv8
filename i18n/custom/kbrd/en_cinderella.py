...
cinderella = [  # 1
    ...
    [[1, 1, 1, 1, 1],
     [
         ...
         "So he bought beautiful dresses, pearls and jewels for his two stepdaughters, and on his way home, as he was riding through a green thicket, a hazel twig brushed against him and knocked off his hat. ",
    ...
    [[1, 1, 1, 1, 1],
     [
         'As, however, Cinderella went on asking, the stepmother at last said, "I have emptied a dish of lentils into the ashes for thee, if thou hast picked them out again in two hours, thou shalt go with us." ',
         ...
         'And the pigeons nodded with their heads and began pick, pick, pick, pick, and the rest began also pick, pick, pick, pick, and gathered all the good grains into the dish. Hardly had one hour passed before they had finished, and all flew out again. ',
         'Then the girl took the dish to her step-mother, and was glad, and believed that now she would be allowed to go with them to the festival. But the step-mother said, "No, Cinderella, thou hast no clothes and thou canst not dance; thou wouldst only be laughed at."'
         ]],  # 5
    [[1, 1, 1, 1, 1],
     [
         ...
         'When the step-mother had emptied the two dishes of lentils amongst the ashes, the maiden went through the back-door into the garden and cried, You tame pigeons, you turtle-doves, and all you birds under heaven, come and help me to pick "The good into the pot, The bad into the crop." ',
    ...
    [[1, 1, 1, 1, 1],
     [
         ...
         "But she could not get her big toe into it, and the shoe was too small for her. Then her mother gave her a knife and said, \"Cut the toe off; when thou art Queen thou wilt have no more need to go on foot.\" The maiden cut the toe off, forced the foot into the shoe, swallowed the pain, and went out to the King's son. Then he took her on his his horse as his bride and rode away with her."
         ]],  # 10
    [[1, 1, 1, 1, 1],
     [
