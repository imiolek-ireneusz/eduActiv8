...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level=1):
        ...
        self.multiplier = 2
        num3 = random.randint(3, 10)
        num1 = random.randint(2, num3-1)
    ...
    def show_info_dialog(self):
        self.mainloop.dialog.show_dialog(3, self.lang.d["To subtract a fraction with the same denominator..."])
    ...
    def update_arrows(self):
        ...
        if self.numbers2[0] == self.numbers[0] - 1:
