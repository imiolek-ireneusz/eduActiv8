...
class Board(gd.BoardGame):
    ...
    def create_game_objects(self, level=1):
        ...
        num2 = random.randint(1, num3-1)
        self.initialize_numbers(num1, num2, num3)
        ...
        self.board.add_unit(f_size-1, f_size, 2, 2, classes.board.Label, "+", white, "", 31)
        ...
        self.positions = [(f_size * 2 + 2 + f_size // 2, f_size),
                          (f_size * 2 + 2 + f_size // 2, f_size + 1),
                          (f_size * 3 + 1, f_size),
                          (f_size * 3 + 3, f_size),
                          (f_size * 3 + 3, f_size + 1),
                          (f_size * 3 + 2, f_size)]
        ...
        self.board.add_unit(self.positions[1][0], self.positions[1][1], 1, 1, classes.board.Label, str(self.sum_numbers[1]),
                            white, "", 25)
        ...
        self.board.add_unit(self.positions2[1][0], self.positions2[1][1], 1, 1, classes.board.Label, "", white, "", 25)
    ...
    def initialize_numbers(self, num1, num2, num3):
        self.numbers = [num1, num3]
        self.numbers2 = [num2, num3]
        self.sum_numbers = [num1 + num2, num3]
        self.gcf = 1
        if num1 + num2 < num3:
            self.res2_numbers = [num1 + num2, num3]
            ...
            self.res2_numbers = [num3, num3]
            self.res1_numbers = [0, 0]
            self.sim2_numbers = [1, 1]
            self.sim1_numbers = [0, 0]
        else:
            self.res2_numbers = [(num1 + num2) - num3, num3]
            self.res1_numbers = [num3, num3]
            # simplify
            self.gcf = self.get_GCF(self.res2_numbers)
            if self.gcf > 1:
                self.sim2_numbers = [int(round(self.res2_numbers[0] / float(self.gcf))),
                ...
                self.sim2_numbers = self.res2_numbers
            self.sim1_numbers = [1, 1]
    ...
    def update_fractions(self):
        ...
        if self.numbers[0] + self.numbers2[0] > self.numbers[1] and self.gcf > 1:
            v = "1"
        else:
            v = ""
        self.smone1.set_value(v)
        ...
        if self.numbers[0] + self.numbers2[0] == self.numbers[1]:
            ...
            self.board.move_unit(self.smone2.unit_id, self.positions2[2][0]+1, self.positions2[2][1])
        elif self.numbers[0] + self.numbers2[0] != self.numbers[1]:
    ...
    def show_info_dialog(self):
        self.mainloop.dialog.show_dialog(3, self.lang.d["To add a fraction with the same denominator..."])
    ...
    def change_fract_btn(self, ns, n1, n2):
        ...
        #make sure both numerators are greater than the denumerator
        if n1 == 1 or n2 == 1:
        ...
        self.initialize_numbers(self.numbers[0], self.numbers2[0], self.numbers2[1])
        self.update_arrows()
        self.update_fractions()
